            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('cow_expenditure.update',$transaction->id)}}">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onfocus="(this. type='date')" class="form-control"
                                                   name="date" value="{{$transaction->date}}" required>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="sub_head_id" id="expenseHeads" class="form-control" required>
                                                <option value="{{$transaction->id}}"
                                                        selected>{{$transaction->accountSubHead->name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="quantity"
                                                   placeholder="quantity" value="{{$transaction->quantity}}" required>
                                        </div>
                                        <div class="form-group">
