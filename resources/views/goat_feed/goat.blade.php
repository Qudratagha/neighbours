                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="example-Modal3">Feed Goat/Sheep</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{route('goat_feed.store')}}">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="submitGoatFeed" class="btn btn-primary">Feed Goat/Sheep</button>
    ...
    <div class="table-responsive">
        <table id="" class="table table-striped table-bordered text-nowrap w-100 display">
            ...
            @foreach($feeds as $feed)
                <tr>
                    <td>{{$feed->cattle_type ? 'Goat/Sheep' : ''}}</td>
                    <td>{{$feed->name}}</td>
