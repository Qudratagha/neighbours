@extends('layouts.nav')
@section('title', 'Cultivaiton Worker Salary')
        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <ol class="breadcrumb"><!-- breadcrumb -->
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Cultivaiton Worker Salary') }}</li>
                </ol><!-- End breadcrumb -->
                <div class="ml-auto">
                    <div class="input-group">
                        <a href="#" type="button" class="btn btn-info" >Add Cultivaiton's Worker Salary</a>
                    </div>
                </div>
            </div>
            <!-- End page-header -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0 card-title">{{ __('Add Cultivaiton\'s Worker Salary') }}</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{route('cultivation_salary.store')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <a href="{{route('cultivation_expenditure.index')}}" type="button" class="btn btn-danger">Back</a>
                            </form>
