                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0 card-title">{{ __('Add Cultivation\'s Expenditure') }}</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{route('cultivation_expenditure.store')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sub_head_id" id="expenseHeads" class="form-control" required required>
