        ...
        <div class="side-app">
            ...
            <div class="page-header">
                <ol class="breadcrumb"><!-- breadcrumb -->
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Dead Goat') }}</li>
                </ol><!-- End breadcrumb -->
            </div>
            <!-- End page-header -->
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="mb-0 card-title">Dead Goat</h3>
                        </div>
                        <div class="card-body">
                            <table cellpadding="2" cellspacing="2" border="1" class="table thead-dark table-bordered table-striped ">
                                ...
                                <tr>
                                    <center>
                                        ...
                                        <th style="font-weight: 600">Dead Date</th>
